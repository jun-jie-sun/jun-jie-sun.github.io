...
1. Mathematical Modeling Competitions: I have actively participated in various domestic and international mathematical modeling competitions, gaining valuable experience in analyzing interdisciplinary research problems. By applying simulation techniques and machine learning algorithms, I was able to develop effective solutions to complex challenges. My achievements include the Second Prize at the university level in the National Mathematical Modeling Competition of China, as well as the F Award (Finalist Award Nomination for Outstanding Performance) in The Mathematical Contest in Modeling and The Interdisciplinary Contest in Modeling (MCM/ICM) in the United States — the highest honor ever awarded to a participant from my university at the time.
